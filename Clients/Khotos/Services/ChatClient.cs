...
namespace Khotos.Services
{
    ...
    public class ChatClient
    {
        ...
        public ChatClient(IHttpClientFactory httpClientFactory, UserService userService, IHttpContextAccessor httpContextAccessor)
        {
                ...
                .WithUrl(url + $"?access_token={JwtAuthorizationMessageHandler.JwtToken}", options =>
                {
                    ...
                    options.AccessTokenProvider = async () =>
                    {
                        ...
                        if (!string.IsNullOrEmpty(accessToken))
                            return accessToken;
                        return JwtAuthorizationMessageHandler.JwtToken;
                    };
                })
                .Build();
